...
class VisitorTrackerService
{
    ...
    public function detectRefererSource(string $referer, string $currentHost): string
    {
        ...
        if (empty($host) || $host === strtolower($currentHost) || str_contains($host, 'pksoganilir.com') || str_contains($host, 'localhost') || str_contains($host, '127.0.0.1')) {
            return 'Direct / Langsung';
        }
    ...
    protected function guessPageTitle(string $path): string
    {
        ...
        $routes = [
            'sejarah' => 'Sejarah Partai',
            'visi-dan-misi' => 'Visi & Misi',
            'tentang-kami' => 'Tentang Kami',
            'sambutan-ketua-dpd' => 'Sambutan Ketua DPD',
            'struktur-kepengurusan' => 'Struktur Kepengurusan',
            'anggota-dewan' => 'Anggota DPRD Fraksi PKS',
            'artikel' => 'Daftar Berita & Artikel',
            'bidang' => 'Daftar Bidang DPD',
