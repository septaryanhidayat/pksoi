    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8 items-start text-center md:text-left">
            ...
            <div class="lg:col-span-2 flex justify-center md:justify-start">
                <img src="/uploads/2025/09/Logo-PKS-Footer-Asli.png" alt="Logo PKS" class="w-28 sm:w-32 h-auto object-contain block shadow-sm mx-auto md:mx-0">
            </div>
            ...
            <div class="lg:col-span-4 space-y-3 text-center md:text-left">
                ...
                <div class="space-y-2 pt-1 text-sm sm:text-[15px] text-white">
                    <div class="flex items-center justify-center md:justify-start space-x-3">
                        ...
                        <a href="tel:{{ $siteSettings['contact_phone'] ?? '082382336505' }}" class="text-white hover:text-[#ff5001] transition">{{ $siteSettings['contact_phone'] ?? '082382336505' }}</a>
                    </div>
                    <div class="flex items-center justify-center md:justify-start space-x-3">
                        <i class="fa-solid fa-envelope text-[#ff5001] w-4 text-center text-sm"></i>
                        <a href="mailto:{{ $siteSettings['contact_email'] ?? 'pksoganilir@gmail.com' }}" class="text-white hover:text-[#ff5001] transition">{{ $siteSettings['contact_email'] ?? 'pksoganilir@gmail.com' }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-3 space-y-2 text-center md:text-left">
                <h4 class="font-semibold text-[#ff5001] text-base sm:text-lg tracking-wide flex items-center justify-center md:justify-start gap-2">
                    <span>Pengunjung</span>
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#ff5001]/20 text-[#ff5001] border border-[#ff5001]/30">
