    ...
    <article class="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-gray-100 reveal-fade-up space-y-8">
        ...
        <div class="prose-content text-gray-700 text-sm sm:text-base leading-relaxed space-y-8">
            ...
            <section class="space-y-2">
                ...
                <p>
                    Kami tidak menjual, menyewakan, atau memindahtangankan data pribadi pengunjung kepada pihak komersial mana pun, kecuali apabila diwajibkan oleh hukum atau putusan pengadilan yang sah di wilayah Republik Indonesia.
                </p>
            </section>
            ...
            <section class="space-y-2">
                ...
                <p>
                    Dengan mengakses dan menggunakan situs resmi <strong>pksoganilir.com</strong>, Anda menyatakan telah membaca, memahami, dan menyetujui seluruh ketentuan dalam Kebijakan Privasi ini.
                </p>
            </section>
            ...
            <section class="space-y-2 bg-gray-50 p-6 rounded-2xl border border-gray-100">
                ...
                <div class="text-xs sm:text-sm space-y-1 text-gray-600 mt-2">
                    <p>📧 Email: <strong>pksoganilir@gmail.com</strong></p>
                    <p>🌐 Website: <strong>https://pksoganilir.com</strong> - <strong>https://oganilir.pks.id</strong></p>
                    <p>📍 Alamat: Jl. Komperta Taman Indralaya Blok C No. 05 Kel. Indralaya Indah, Kab. Ogan Ilir, Sumatera Selatan</p>
                </div>
            </section>
