        ...
        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-xs border border-slate-200/80 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="icon" value="{{ old('icon', '/uploads/2025/09/ICON-Berita.webp') }}" placeholder="/uploads/... atau fa-solid fa-bolt" class="w-full bg-slate-50 text-xs text-slate-800 rounded-xl px-4 py-3 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#ff5001] font-mono">
                </div>
            </div>
